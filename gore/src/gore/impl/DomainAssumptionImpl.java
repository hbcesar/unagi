 ...
 * </p>
 * <ul>
 *   <li>{@link gore.impl.DomainAssumptionImpl#getParent <em>Parent</em>}</li>
 * </ul>
 *
 * @generated
 */
public class DomainAssumptionImpl extends GOREElementImpl implements DomainAssumption {
	...
	public String getShortName() {
		return "DA_" + this.name.replace(" ", "_");
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == GOREElement.class) {
			switch (baseOperationID) {
				case GorePackage.GORE_ELEMENT___GET_SHORT_NAME: return GorePackage.DOMAIN_ASSUMPTION___GET_SHORT_NAME;
				case GorePackage.GORE_ELEMENT___GET_TYPE: return GorePackage.DOMAIN_ASSUMPTION___GET_TYPE;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case GorePackage.DOMAIN_ASSUMPTION___GET_SHORT_NAME:
				return getShortName();
			case GorePackage.DOMAIN_ASSUMPTION___GET_TYPE:
				return getType();
		}
