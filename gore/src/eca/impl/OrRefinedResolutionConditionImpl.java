 ...
 * </p>
 * <ul>
 *   <li>{@link eca.impl.OrRefinedResolutionConditionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrRefinedResolutionConditionImpl extends ResolutionConditionImpl implements OrRefinedResolutionCondition {
	...
	public EList<ResolutionCondition> getChildren() {
		if (children == null) {
			children = new EObjectResolvingEList<ResolutionCondition>(ResolutionCondition.class, this, EcaPackage.OR_REFINED_RESOLUTION_CONDITION__CHILDREN);
		}
		return children;
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ResolutionCondition.class) {
			switch (baseOperationID) {
				case EcaPackage.RESOLUTION_CONDITION___GET_ALL_PARAMETERS: return EcaPackage.OR_REFINED_RESOLUTION_CONDITION___GET_ALL_PARAMETERS;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case EcaPackage.OR_REFINED_RESOLUTION_CONDITION___GET_ALL_PARAMETERS:
