...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Relax Replace Child Strategy</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link eca.impl.RelaxReplaceChildStrategyImpl#getRequirement <em>Requirement</em>}</li>
 *   <li>{@link eca.impl.RelaxReplaceChildStrategyImpl#getNewRequirement <em>New Requirement</em>}</li>
 *   <li>{@link eca.impl.RelaxReplaceChildStrategyImpl#getLevel <em>Level</em>}</li>
 *   <li>{@link eca.impl.RelaxReplaceChildStrategyImpl#isCopy <em>Copy</em>}</li>
 * </ul>
 *
 * @generated
 */
public class RelaxReplaceChildStrategyImpl extends AdaptationStrategyImpl implements RelaxReplaceChildStrategy {
	/**
	 ...
	 * @generated
	 */
	protected RelaxReplaceChildStrategyImpl() {
		super();
	}
	...
	protected EClass eStaticClass() {
		return EcaPackage.Literals.RELAX_REPLACE_CHILD_STRATEGY;
	}
		...
		if (requirement != null && requirement.eIsProxy()) {
			...
			if (requirement != oldRequirement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__REQUIREMENT, oldRequirement, requirement));
			}
		}
		return requirement;
	}
	...
	public void setRequirement(GOREElement newRequirement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__REQUIREMENT, oldRequirement, requirement));
	}
	...
	public GOREElement getNewRequirement() {
		if (newRequirement != null && newRequirement.eIsProxy()) {
			...
			if (newRequirement != oldNewRequirement) {
				if (eNotificationRequired())
					eNotify(new ENotificationImpl(this, Notification.RESOLVE, EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__NEW_REQUIREMENT, oldNewRequirement, newRequirement));
			}
		}
	...
	public void setNewRequirement(GOREElement newNewRequirement) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__NEW_REQUIREMENT, oldNewRequirement, newRequirement));
	}
	...
	public void setLevel(AgregationLevel newLevel) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__LEVEL, oldLevel, level));
	}
	...
	public void setCopy(boolean newCopy) {
		...
		copy = newCopy;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__COPY, oldCopy, copy));
	}
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
			case EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__REQUIREMENT:
				if (resolve) return getRequirement();
				return basicGetRequirement();
			case EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__NEW_REQUIREMENT:
				if (resolve) return getNewRequirement();
				return basicGetNewRequirement();
			case EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__LEVEL:
				return getLevel();
			case EcaPackage.RELAX_REPLACE_CHILD_STRATEGY__COPY:
				return isCopy();
		}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == AdaptationStrategy.class) {
			switch (baseOperationID) {
				case EcaPackage.ADAPTATION_STRATEGY___GET_ALL_PARAMETERS: return EcaPackage.RELAX_REPLACE_CHILD_STRATEGY___GET_ALL_PARAMETERS;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case EcaPackage.RELAX_REPLACE_CHILD_STRATEGY___GET_ALL_PARAMETERS:
