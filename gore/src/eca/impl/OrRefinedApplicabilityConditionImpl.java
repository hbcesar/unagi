 ...
 * </p>
 * <ul>
 *   <li>{@link eca.impl.OrRefinedApplicabilityConditionImpl#getChildren <em>Children</em>}</li>
 * </ul>
 *
 * @generated
 */
public class OrRefinedApplicabilityConditionImpl extends ApplicabilityConditionImpl implements OrRefinedApplicabilityCondition {
	...
	public EList<ApplicabilityCondition> getChildren() {
		if (children == null) {
			children = new EObjectResolvingEList<ApplicabilityCondition>(ApplicabilityCondition.class, this, EcaPackage.OR_REFINED_APPLICABILITY_CONDITION__CHILDREN);
		}
		return children;
	}
	...
	public int eDerivedOperationID(int baseOperationID, Class<?> baseClass) {
		if (baseClass == ApplicabilityCondition.class) {
			switch (baseOperationID) {
				case EcaPackage.APPLICABILITY_CONDITION___GET_ALL_PARAMETERS: return EcaPackage.OR_REFINED_APPLICABILITY_CONDITION___GET_ALL_PARAMETERS;
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case EcaPackage.OR_REFINED_APPLICABILITY_CONDITION___GET_ALL_PARAMETERS:
